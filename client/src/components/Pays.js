...
import {getAllPays, addPay, deletePay, updatePay, filterPayByMonth, filterPayKey} from '../actions/pays.actions'
...
export default connect(mapStateToProps, {getAllPays, addPay, deletePay, updatePay, filterPayByMonth, filterPayKey}) (Pays);