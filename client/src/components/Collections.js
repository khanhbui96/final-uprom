    ...
    const Collection = (collection)=>{
        return <TableRow >
                            ...
                            <StyledTableCell align="left">
                                ...
                                <Button variant="outlined" size="small" color="primary" className={classes.margin} onClick={() => { deleteCollection(collection._id) }}>
                                    Xóa
                                </Button>
                            </StyledTableCell>
                        </TableRow>
...
export default connect(mapStateToProps, { getAllCollections, 
    deleteCollection, 
    addCollection, 
    updateCollection, 
    filterCollectionByMonth,
